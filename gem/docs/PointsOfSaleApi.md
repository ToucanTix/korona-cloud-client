...
| [**add_point_of_sale_pos_balances**](PointsOfSaleApi.md#add_point_of_sale_pos_balances) | **POST** /accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/posBalances |  |
...
| [**get_default_user**](PointsOfSaleApi.md#get_default_user) | **GET** /accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/defaultUser |  |
...
| [**get_point_of_sale_max_numbers**](PointsOfSaleApi.md#get_point_of_sale_max_numbers) | **GET** /accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/maxNumbers |  |
...
## add_point_of_sale_pos_balances

> <Array<AddOrUpdateResult>> add_point_of_sale_pos_balances(korona_account_id, point_of_sale_id, coupling_id, opts)
...
coupling_id = 'coupling_id_example' # String | the coupling-id of the device
opts = {
  pos_balance: [KoronaCloudClient::PosBalance.new] # Array<PosBalance> | the pos balances to add
}

begin

  result = api_instance.add_point_of_sale_pos_balances(korona_account_id, point_of_sale_id, coupling_id, opts)
  p result
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->add_point_of_sale_pos_balances: #{e}"
end
```

#### Using the add_point_of_sale_pos_balances_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<AddOrUpdateResult>>, Integer, Hash)> add_point_of_sale_pos_balances_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts)

```ruby
begin

  data, status_code, headers = api_instance.add_point_of_sale_pos_balances_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<AddOrUpdateResult>>
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->add_point_of_sale_pos_balances_with_http_info: #{e}"
end
```
...
| **point_of_sale_id** | **String** | id of the related object (important: id should match the uuid-format) |  |
| **coupling_id** | **String** | the coupling-id of the device |  |
| **pos_balance** | [**Array&lt;PosBalance&gt;**](PosBalance.md) | the pos balances to add | [optional] |
...
> <DefaultUser> get_default_user(korona_account_id, point_of_sale_id, opts)
...
begin
  ...
  result = api_instance.get_default_user(korona_account_id, point_of_sale_id, opts)
  p result
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->get_default_user: #{e}"
end
```

#### Using the get_default_user_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DefaultUser>, Integer, Hash)> get_default_user_with_http_info(korona_account_id, point_of_sale_id, opts)

```ruby
begin

  data, status_code, headers = api_instance.get_default_user_with_http_info(korona_account_id, point_of_sale_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DefaultUser>
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->get_default_user_with_http_info: #{e}"
end
```
...
## get_point_of_sale_max_numbers

> <PosMaxNumbers> get_point_of_sale_max_numbers(korona_account_id, point_of_sale_id, opts)
...
begin
  ...
  result = api_instance.get_point_of_sale_max_numbers(korona_account_id, point_of_sale_id, opts)
  p result
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->get_point_of_sale_max_numbers: #{e}"
end
```

#### Using the get_point_of_sale_max_numbers_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PosMaxNumbers>, Integer, Hash)> get_point_of_sale_max_numbers_with_http_info(korona_account_id, point_of_sale_id, opts)

```ruby
begin

  data, status_code, headers = api_instance.get_point_of_sale_max_numbers_with_http_info(korona_account_id, point_of_sale_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PosMaxNumbers>
rescue KoronaCloudClient::ApiError => e
  puts "Error when calling PointsOfSaleApi->get_point_of_sale_max_numbers_with_http_info: #{e}"
end
```
...
[**PosMaxNumbers**](PosMaxNumbers.md)
