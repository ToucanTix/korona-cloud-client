...
opts = {
  ...
  voucher_configuration: 'voucher_configuration_example', # String | voucher configuration id to filter by
...
| **voucher_configuration** | **String** | voucher configuration id to filter by | [optional] |
