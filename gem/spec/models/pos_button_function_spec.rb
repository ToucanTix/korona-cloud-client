...
describe KoronaCloudClient::PosButtonFunction do
  ...
  describe 'test attribute "internal_system_call_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["MESSAGE", "STOCK", "CUSTOMER", "CASHIER", "DAY_RATING", "BONUS_POINTS", "RESOLVE_UNKNOWN_PRODUCTS", "EVENTS", "EVENTS_VALIDATION", "CASHIER_SALES", "SQUARE_INITIALIZATION", "VOUCHER"])
      # validator.allowable_values.each do |value|
