...
describe 'ReceiptLayoutConfigurationsApi' do
  ...
  # @param receipt_layout_configuration array of new receipt layout configurations
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param receipt_layout_configuration array of existing receipt layout configurations (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param receipt_layout_configuration_id id of the related object (important: id should match the uuid-format)
  # @param receipt_layout_configuration the properties to update of the receipt layout configuration
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param receipt_layout_configuration an array of existing receipt layout configurations
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
