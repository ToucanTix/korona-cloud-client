...
describe 'CashierRolesApi' do
  ...
  # @param cashier_role an array of new cashier roles
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param cashier_role array of existing cashier roles (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param cashier_role_id id of the related object (important: id should match the uuid-format)
  # @param cashier_role the properties to update of the cashier role
  # @param [Hash] opts the optional parameters
  # @return [nil]
