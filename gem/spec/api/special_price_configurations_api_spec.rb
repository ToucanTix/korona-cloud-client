...
describe 'SpecialPriceConfigurationsApi' do
  ...
  # @param special_price_configuration array of new special price configurations
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param special_price_configuration array of existing special price configurations (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
