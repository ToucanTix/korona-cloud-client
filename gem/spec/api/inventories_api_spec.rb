...
describe 'InventoriesApi' do
  ...
  # @param inventory an array of new inventories
  ...
  # @param inventory_list_item data to update
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param inventory_id id of the related object (important: id should match the uuid-format)
  # @param inventory the properties to update of the inventory
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param inventory_id id of the related object (important: id should match the uuid-format)
  # @param inventory_list_id id of the related object (important: id should match the uuid-format)
  # @param inventory_list data to update
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param inventory_id id of the related object (important: id should match the uuid-format)
  # @param inventory_list_id id of the related object (important: id should match the uuid-format)
  # @param inventory_list_item an array of inventory list items to update
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
