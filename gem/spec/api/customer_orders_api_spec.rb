...
describe 'CustomerOrdersApi' do
  ...
  # @param customer_order array of new customer orders
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param customer_order_id id of the related object (important: id should match the uuid-format)
  # @param customer_order the properties to update of the customer order
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param customer_order an array of existing customer orders
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
