...
describe 'PromotionsApi' do
  ...
  # @param promotion array of new promotions
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param promotion array of existing promotions (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param promotion_id id of the related object (important: id should match the uuid-format)
  # @param promotion the properties to update of the promotion
  # @param [Hash] opts the optional parameters
  # @return [nil]
