...
describe 'CommodityGroupsApi' do
  ...
  # @param commodity_group an array of new commodity groups
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param commodity_group array of existing commodity groups (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param commodity_group_id id of the related object (important: id should match the uuid-format)
  # @param commodity_group the properties to update of the commodity group
  # @param [Hash] opts the optional parameters
  # @return [nil]
