...
describe 'OrganizationalUnitsApi' do
  ...
  # @param day_rating an array of new day ratings
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param organizational_unit an array of new organizational units
  # @param [Hash] opts the optional parameters
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param organizational_unit array of existing organizational units (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # unit tests for get_organizational_unit_product_stocks1
  ...
  # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
  # @return [ResultListProductStock]
  describe 'get_organizational_unit_product_stocks1 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param organizational_unit_id id of the related object (important: id should match the uuid-format)
  # @param organizational_unit the properties to update of the organizational unit
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param organizational_unit_id id of the related object (important: id should match the uuid-format)
  # @param day_rating_id_or_date the id or date (YYYY-MM-DD) of the day rating
  # @param day_rating the properties to update of the day rating
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param organizational_unit an array of existing organizational units
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
