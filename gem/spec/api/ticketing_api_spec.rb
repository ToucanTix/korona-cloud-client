...
describe 'TicketingApi' do
  ...
  # @param creation_task a single ticket creation task
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param entry_gate array of new entry gates
  # @param [Hash] opts the optional parameters
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param event an array of new events
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :upsert when set to true, updates the object instead of generating a already-exists-error; deprecated, use writeMode ADD_OR_UPDATE instead
  # @option opts [String] :write_mode DEFAULT &#x3D; insert; ADD_OR_UPDATE &#x3D; insert or update, overwrite all non-null fields; ADD_OR_REPLACE &#x3D; insert or update, overwrite all fields
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param attendance an array of attendances
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param ticket_definition array of new ticket definitions
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :upsert when set to true, updates the object instead of generating a already-exists-error; deprecated, use writeMode ADD_OR_UPDATE instead
  # @option opts [String] :write_mode DEFAULT &#x3D; insert; ADD_OR_UPDATE &#x3D; insert or update, overwrite all non-null fields; ADD_OR_REPLACE &#x3D; insert or update, overwrite all fields
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param entry_gate array of existing entry gates (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param ticket_definition array of existing ticket definitions (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param event_id id of the related object (important: id should match the uuid-format)
  # @param event the properties to update of the event
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param event an array of existing events
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
