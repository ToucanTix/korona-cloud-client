...
describe 'CustomerGroupsApi' do
  ...
  # @param customer_group array of new customer groups
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param customer_group array of existing customer groups (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param customer_group_id id of the related object (important: id should match the uuid-format)
  # @param customer_group the properties to update of the customer group
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param customer_group an array of existing customer groups
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
