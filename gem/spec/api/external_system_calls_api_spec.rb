...
describe 'ExternalSystemCallsApi' do
  ...
  # @param external_system_call array of new external system calls
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param external_system_call array of existing external system calls (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param external_system_call_id id of the related object (important: id should match the uuid-format)
  # @param external_system_call the properties to update of the external system call
  # @param [Hash] opts the optional parameters
  # @return [nil]
