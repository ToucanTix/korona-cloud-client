...
describe 'StockAdjustmentsApi' do
  ...
  # @param stock_adjustment_item data to add
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param stock_adjustment data to add
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param stock_adjustment_id id of the related object (important: id should match the uuid-format)
  # @param stock_adjustment data to update
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param stock_adjustment_id id of the related object (important: id should match the uuid-format)
  # @param product_id id of the related object (important: id should match the uuid-format)
  # @param stock_adjustment_item data to update
  # @param [Hash] opts the optional parameters
  # @return [nil]
