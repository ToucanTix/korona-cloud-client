...
describe 'ContraAccountsApi' do
  ...
  # @param contra_account array of new contra accounts
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param contra_account array of existing contra accounts (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param contra_account_id id of the related object (important: id should match the uuid-format)
  # @param contra_account the properties to update of the contra account
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param contra_account an array of existing contra accounts
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
