...
describe 'PriceRulesApi' do
  ...
  # @param price_rule array of new price rules
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param price_rule array of existing price rules (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param price_rule_id id of the related object (important: id should match the uuid-format)
  # @param price_rule the properties to update of the price rule
  # @param [Hash] opts the optional parameters
  # @return [nil]
