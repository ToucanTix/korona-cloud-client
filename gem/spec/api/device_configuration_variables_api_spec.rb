...
describe 'DeviceConfigurationVariablesApi' do
  ...
  # @param device_configuration_variable array of new device configuration variables
  ...
  # @param korona_account_id account id of the KORONA Studio account
  # @param device_configuration_variable array of existing device configuration variables (id or number required)
  # @param [Hash] opts the optional parameters
  # @return [Array<AddOrUpdateResult>]
