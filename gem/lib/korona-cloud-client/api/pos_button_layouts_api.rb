...
module KoronaCloudClient
  class PosButtonLayoutsApi
    ...
    # @param pos_button_layout [Array<PosButtonLayout>] array of new pos button layouts
    ...
    def add_pos_button_layouts(korona_account_id, pos_button_layout, opts = {})
      data, _status_code, _headers = add_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts)
      data
    end
    ...
    def add_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts = {})
      ...
      # verify the required parameter 'pos_button_layout' is set
      if @api_client.config.client_side_validation && pos_button_layout.nil?
        fail ArgumentError, "Missing the required parameter 'pos_button_layout' when calling PosButtonLayoutsApi.add_pos_button_layouts"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(pos_button_layout)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param pos_button_layout [Array<PosButtonLayout>] array of existing pos button layouts (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_pos_button_layouts(korona_account_id, pos_button_layout, opts = {})
      data, _status_code, _headers = delete_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pos_button_layout' is set
      if @api_client.config.client_side_validation && pos_button_layout.nil?
        fail ArgumentError, "Missing the required parameter 'pos_button_layout' when calling PosButtonLayoutsApi.delete_pos_button_layouts"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/posButtonLayouts'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param pos_button_layout_id [String] id of the related object (important: id should match the uuid-format)
    # @param pos_button_layout [PosButtonLayout] the properties to update of the pos button layout
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_pos_button_layout(korona_account_id, pos_button_layout_id, pos_button_layout, opts = {})
      update_pos_button_layout_with_http_info(korona_account_id, pos_button_layout_id, pos_button_layout, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_pos_button_layout_with_http_info(korona_account_id, pos_button_layout_id, pos_button_layout, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pos_button_layout' is set
      if @api_client.config.client_side_validation && pos_button_layout.nil?
        fail ArgumentError, "Missing the required parameter 'pos_button_layout' when calling PosButtonLayoutsApi.update_pos_button_layout"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/posButtonLayouts/{posButtonLayoutId}'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s)).sub('{posButtonLayoutId}', CGI.escape(pos_button_layout_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param pos_button_layout [Array<PosButtonLayout>] an array of existing pos button layouts
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_pos_button_layouts(korona_account_id, pos_button_layout, opts = {})
      data, _status_code, _headers = update_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_pos_button_layouts_with_http_info(korona_account_id, pos_button_layout, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pos_button_layout' is set
      if @api_client.config.client_side_validation && pos_button_layout.nil?
        fail ArgumentError, "Missing the required parameter 'pos_button_layout' when calling PosButtonLayoutsApi.update_pos_button_layouts"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/posButtonLayouts'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
