...
module KoronaCloudClient
  class UserRolesApi
    ...
    # @param user_role [Array<UserRole>] an array of new user roles
    ...
    def add_user_roles(korona_account_id, user_role, opts = {})
      data, _status_code, _headers = add_user_roles_with_http_info(korona_account_id, user_role, opts)
      data
    end
    ...
    def add_user_roles_with_http_info(korona_account_id, user_role, opts = {})
      ...
      if @api_client.config.client_side_validation && user_role.nil?
        fail ArgumentError, "Missing the required parameter 'user_role' when calling UserRolesApi.add_user_roles"
      end
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param user_role [Array<UserRole>] array of existing user roles
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_user_roles(korona_account_id, user_role, opts = {})
      data, _status_code, _headers = delete_user_roles_with_http_info(korona_account_id, user_role, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_user_roles_with_http_info(korona_account_id, user_role, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'user_role' is set
      if @api_client.config.client_side_validation && user_role.nil?
        fail ArgumentError, "Missing the required parameter 'user_role' when calling UserRolesApi.delete_user_roles"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/userRoles'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param user_role_id [String] id of the related object (important: id should match the uuid-format)
    # @param user_role [UserRole] the properties to update of the user role
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_user_role(korona_account_id, user_role_id, user_role, opts = {})
      update_user_role_with_http_info(korona_account_id, user_role_id, user_role, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_user_role_with_http_info(korona_account_id, user_role_id, user_role, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'user_role' is set
      if @api_client.config.client_side_validation && user_role.nil?
        fail ArgumentError, "Missing the required parameter 'user_role' when calling UserRolesApi.update_user_role"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/userRoles/{userRoleId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'userRoleId' + '}', CGI.escape(user_role_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_user_roles(korona_account_id, user_role, opts = {})
      data, _status_code, _headers = update_user_roles_with_http_info(korona_account_id, user_role, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_user_roles_with_http_info(korona_account_id, user_role, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'user_role' is set
      if @api_client.config.client_side_validation && user_role.nil?
        fail ArgumentError, "Missing the required parameter 'user_role' when calling UserRolesApi.update_user_roles"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/userRoles'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
