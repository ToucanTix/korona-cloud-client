...
module KoronaCloudClient
  class SectorsApi
    ...
    # @param sector [Array<Sector>] array of new sectors
    ...
    def add_sectors(korona_account_id, sector, opts = {})
      data, _status_code, _headers = add_sectors_with_http_info(korona_account_id, sector, opts)
      data
    end
    ...
    def add_sectors_with_http_info(korona_account_id, sector, opts = {})
      ...
      if @api_client.config.client_side_validation && sector.nil?
        fail ArgumentError, "Missing the required parameter 'sector' when calling SectorsApi.add_sectors"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(sector)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param sector [Array<Sector>] array of existing sectors (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_sectors(korona_account_id, sector, opts = {})
      data, _status_code, _headers = delete_sectors_with_http_info(korona_account_id, sector, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_sectors_with_http_info(korona_account_id, sector, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'sector' is set
      if @api_client.config.client_side_validation && sector.nil?
        fail ArgumentError, "Missing the required parameter 'sector' when calling SectorsApi.delete_sectors"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/sectors'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_sectors(korona_account_id, sector, opts = {})
      data, _status_code, _headers = update_sectors_with_http_info(korona_account_id, sector, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_sectors_with_http_info(korona_account_id, sector, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'sector' is set
      if @api_client.config.client_side_validation && sector.nil?
        fail ArgumentError, "Missing the required parameter 'sector' when calling SectorsApi.update_sectors"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/sectors'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
