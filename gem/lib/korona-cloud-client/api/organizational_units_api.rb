...
module KoronaCloudClient
  class OrganizationalUnitsApi
    ...
    # @param day_rating [Array<DayRating>] an array of new day ratings
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_organizational_unit_day_ratings(korona_account_id, organizational_unit_id, day_rating, opts = {})
      data, _status_code, _headers = add_organizational_unit_day_ratings_with_http_info(korona_account_id, organizational_unit_id, day_rating, opts)
      data
    end
    ...
    def add_organizational_unit_day_ratings_with_http_info(korona_account_id, organizational_unit_id, day_rating, opts = {})
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param organizational_unit [Array<OrganizationalUnit>] an array of new organizational units
    # @param [Hash] opts the optional parameters
    ...
    # @return [Array<AddOrUpdateResult>]
    def add_organizational_units(korona_account_id, organizational_unit, opts = {})
      data, _status_code, _headers = add_organizational_units_with_http_info(korona_account_id, organizational_unit, opts)
      data
    end
    ...
    # @option opts [String] :write_mode DEFAULT &#x3D; insert; ADD_OR_UPDATE &#x3D; insert or update, overwrite all non-null fields; ADD_OR_REPLACE &#x3D; insert or update, overwrite all fields
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_organizational_units_with_http_info(korona_account_id, organizational_unit, opts = {})
      if @api_client.config.debugging
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param organizational_unit [Array<OrganizationalUnit>] array of existing organizational units (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_organizational_units(korona_account_id, organizational_unit, opts = {})
      data, _status_code, _headers = delete_organizational_units_with_http_info(korona_account_id, organizational_unit, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_organizational_units_with_http_info(korona_account_id, organizational_unit, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
    # @option opts [Array<ModelReference>] :model_reference product data to filter
    ...
    def get_organizational_unit_product_stocks_with_http_info(korona_account_id, organizational_unit_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'model_reference'])
    ...
    # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
    # @return [ResultListProductStock]
    def get_organizational_unit_product_stocks1(korona_account_id, organizational_unit_id, opts = {})
      data, _status_code, _headers = get_organizational_unit_product_stocks1_with_http_info(korona_account_id, organizational_unit_id, opts)
      data
    end
    ...
    # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
    # @return [Array<(ResultListProductStock, Integer, Hash)>] ResultListProductStock data, response status code and response headers
    def get_organizational_unit_product_stocks1_with_http_info(korona_account_id, organizational_unit_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationalUnitsApi.get_organizational_unit_product_stocks1 ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling OrganizationalUnitsApi.get_organizational_unit_product_stocks1"
      end
      # verify the required parameter 'organizational_unit_id' is set
      if @api_client.config.client_side_validation && organizational_unit_id.nil?
        fail ArgumentError, "Missing the required parameter 'organizational_unit_id' when calling OrganizationalUnitsApi.get_organizational_unit_product_stocks1"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/organizationalUnits/{organizationalUnitId}/productStocks'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'organizationalUnitId' + '}', CGI.escape(organizational_unit_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OrganizationalUnitsApi.get_organizational_unit_product_stocks1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationalUnitsApi#get_organizational_unit_product_stocks1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param organizational_unit_id [String] id of the related object (important: id should match the uuid-format)
    # @param organizational_unit [OrganizationalUnit] the properties to update of the organizational unit
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_organizational_unit(korona_account_id, organizational_unit_id, organizational_unit, opts = {})
      update_organizational_unit_with_http_info(korona_account_id, organizational_unit_id, organizational_unit, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_organizational_unit_with_http_info(korona_account_id, organizational_unit_id, organizational_unit, opts = {})
      if @api_client.config.debugging
    ...
    # @param organizational_unit_id [String] id of the related object (important: id should match the uuid-format)
    # @param day_rating_id_or_date [String] the id or date (YYYY-MM-DD) of the day rating
    # @param day_rating [DayRating] the properties to update of the day rating
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_organizational_unit_day_rating(korona_account_id, organizational_unit_id, day_rating_id_or_date, day_rating, opts = {})
      update_organizational_unit_day_rating_with_http_info(korona_account_id, organizational_unit_id, day_rating_id_or_date, day_rating, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_organizational_unit_day_rating_with_http_info(korona_account_id, organizational_unit_id, day_rating_id_or_date, day_rating, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_organizational_unit_day_ratings(korona_account_id, organizational_unit_id, day_rating, opts = {})
      data, _status_code, _headers = update_organizational_unit_day_ratings_with_http_info(korona_account_id, organizational_unit_id, day_rating, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_organizational_unit_day_ratings_with_http_info(korona_account_id, organizational_unit_id, day_rating, opts = {})
      if @api_client.config.debugging
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param organizational_unit [Array<OrganizationalUnit>] an array of existing organizational units
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_organizational_units(korona_account_id, organizational_unit, opts = {})
      data, _status_code, _headers = update_organizational_units_with_http_info(korona_account_id, organizational_unit, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_organizational_units_with_http_info(korona_account_id, organizational_unit, opts = {})
      if @api_client.config.debugging
