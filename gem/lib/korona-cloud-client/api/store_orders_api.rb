...
module KoronaCloudClient
  class StoreOrdersApi
    ...
    # @param store_order_item [Array<StoreOrderItem>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_store_order_items(korona_account_id, store_order_id, store_order_item, opts = {})
      data, _status_code, _headers = add_store_order_items_with_http_info(korona_account_id, store_order_id, store_order_item, opts)
      data
    end
    ...
    def add_store_order_items_with_http_info(korona_account_id, store_order_id, store_order_item, opts = {})
      ...
      # verify the required parameter 'store_order_item' is set
      if @api_client.config.client_side_validation && store_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'store_order_item' when calling StoreOrdersApi.add_store_order_items"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(store_order_item)
    ...
    # adds store orders
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param store_order [Array<StoreOrder>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_store_orders(korona_account_id, store_order, opts = {})
      data, _status_code, _headers = add_store_orders_with_http_info(korona_account_id, store_order, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_store_orders_with_http_info(korona_account_id, store_order, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'store_order' is set
      if @api_client.config.client_side_validation && store_order.nil?
        fail ArgumentError, "Missing the required parameter 'store_order' when calling StoreOrdersApi.add_store_orders"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(store_order)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param store_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param store_order [StoreOrder] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_store_order(korona_account_id, store_order_id, store_order, opts = {})
      update_store_order_with_http_info(korona_account_id, store_order_id, store_order, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_store_order_with_http_info(korona_account_id, store_order_id, store_order, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'store_order' is set
      if @api_client.config.client_side_validation && store_order.nil?
        fail ArgumentError, "Missing the required parameter 'store_order' when calling StoreOrdersApi.update_store_order"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/storeOrders/{storeOrderId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'storeOrderId' + '}', CGI.escape(store_order_id.to_s))
    ...
    # @param store_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param product_id [String] id of the related object (important: id should match the uuid-format)
    # @param store_order_item [StoreOrderItem] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_store_order_item(korona_account_id, store_order_id, product_id, store_order_item, opts = {})
      update_store_order_item_with_http_info(korona_account_id, store_order_id, product_id, store_order_item, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_store_order_item_with_http_info(korona_account_id, store_order_id, product_id, store_order_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'store_order_item' is set
      if @api_client.config.client_side_validation && store_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'store_order_item' when calling StoreOrdersApi.update_store_order_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/storeOrders/{storeOrderId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'storeOrderId' + '}', CGI.escape(store_order_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param store_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param store_order_item [Array<StoreOrderItem>] data to update
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_store_order_items(korona_account_id, store_order_id, store_order_item, opts = {})
      data, _status_code, _headers = update_store_order_items_with_http_info(korona_account_id, store_order_id, store_order_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_store_order_items_with_http_info(korona_account_id, store_order_id, store_order_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'store_order_item' is set
      if @api_client.config.client_side_validation && store_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'store_order_item' when calling StoreOrdersApi.update_store_order_items"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/storeOrders/{storeOrderId}/items'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'storeOrderId' + '}', CGI.escape(store_order_id.to_s))
