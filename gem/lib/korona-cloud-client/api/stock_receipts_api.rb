...
module KoronaCloudClient
  class StockReceiptsApi
    ...
    # @param stock_receipt_item [Array<StockReceiptItem>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_receipt_items(korona_account_id, stock_receipt_id, stock_receipt_item, opts = {})
      data, _status_code, _headers = add_stock_receipt_items_with_http_info(korona_account_id, stock_receipt_id, stock_receipt_item, opts)
      data
    end
    ...
    def add_stock_receipt_items_with_http_info(korona_account_id, stock_receipt_id, stock_receipt_item, opts = {})
      ...
      # verify the required parameter 'stock_receipt_item' is set
      if @api_client.config.client_side_validation && stock_receipt_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_receipt_item' when calling StockReceiptsApi.add_stock_receipt_items"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(stock_receipt_item)
    ...
    # adds stock-receipts
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_receipt [Array<StockReceipt>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_receipts(korona_account_id, stock_receipt, opts = {})
      data, _status_code, _headers = add_stock_receipts_with_http_info(korona_account_id, stock_receipt, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_stock_receipts_with_http_info(korona_account_id, stock_receipt, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_receipt' is set
      if @api_client.config.client_side_validation && stock_receipt.nil?
        fail ArgumentError, "Missing the required parameter 'stock_receipt' when calling StockReceiptsApi.add_stock_receipts"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(stock_receipt)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_receipt_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_receipt [StockReceipt] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_receipt(korona_account_id, stock_receipt_id, stock_receipt, opts = {})
      update_stock_receipt_with_http_info(korona_account_id, stock_receipt_id, stock_receipt, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_receipt_with_http_info(korona_account_id, stock_receipt_id, stock_receipt, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_receipt' is set
      if @api_client.config.client_side_validation && stock_receipt.nil?
        fail ArgumentError, "Missing the required parameter 'stock_receipt' when calling StockReceiptsApi.update_stock_receipt"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockReceipts/{stockReceiptId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockReceiptId' + '}', CGI.escape(stock_receipt_id.to_s))
    ...
    # @param stock_receipt_id [String] id of the related object (important: id should match the uuid-format)
    # @param product_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_receipt_item [StockReceiptItem] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_receipt_item(korona_account_id, stock_receipt_id, product_id, stock_receipt_item, opts = {})
      update_stock_receipt_item_with_http_info(korona_account_id, stock_receipt_id, product_id, stock_receipt_item, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_receipt_item_with_http_info(korona_account_id, stock_receipt_id, product_id, stock_receipt_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_receipt_item' is set
      if @api_client.config.client_side_validation && stock_receipt_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_receipt_item' when calling StockReceiptsApi.update_stock_receipt_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockReceipts/{stockReceiptId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockReceiptId' + '}', CGI.escape(stock_receipt_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_receipt_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_receipt_item [Array<StockReceiptItem>] data to update
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_stock_receipt_items(korona_account_id, stock_receipt_id, stock_receipt_item, opts = {})
      data, _status_code, _headers = update_stock_receipt_items_with_http_info(korona_account_id, stock_receipt_id, stock_receipt_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_stock_receipt_items_with_http_info(korona_account_id, stock_receipt_id, stock_receipt_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_receipt_item' is set
      if @api_client.config.client_side_validation && stock_receipt_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_receipt_item' when calling StockReceiptsApi.update_stock_receipt_items"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockReceipts/{stockReceiptId}/items'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockReceiptId' + '}', CGI.escape(stock_receipt_id.to_s))
