...
module KoronaCloudClient
  class InfoTextsApi
    ...
    # @param info_text [Array<InfoText>] array of new info texts
    ...
    def add_info_texts(korona_account_id, info_text, opts = {})
      data, _status_code, _headers = add_info_texts_with_http_info(korona_account_id, info_text, opts)
      data
    end
    ...
    def add_info_texts_with_http_info(korona_account_id, info_text, opts = {})
      ...
      if @api_client.config.client_side_validation && info_text.nil?
        fail ArgumentError, "Missing the required parameter 'info_text' when calling InfoTextsApi.add_info_texts"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(info_text)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param info_text [Array<InfoText>] array of existing info texts (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_info_texts(korona_account_id, info_text, opts = {})
      data, _status_code, _headers = delete_info_texts_with_http_info(korona_account_id, info_text, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_info_texts_with_http_info(korona_account_id, info_text, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'info_text' is set
      if @api_client.config.client_side_validation && info_text.nil?
        fail ArgumentError, "Missing the required parameter 'info_text' when calling InfoTextsApi.delete_info_texts"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/infoTexts'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_info_texts(korona_account_id, info_text, opts = {})
      data, _status_code, _headers = update_info_texts_with_http_info(korona_account_id, info_text, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_info_texts_with_http_info(korona_account_id, info_text, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'info_text' is set
      if @api_client.config.client_side_validation && info_text.nil?
        fail ArgumentError, "Missing the required parameter 'info_text' when calling InfoTextsApi.update_info_texts"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/infoTexts'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
