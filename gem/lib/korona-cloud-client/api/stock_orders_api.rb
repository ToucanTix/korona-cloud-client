...
module KoronaCloudClient
  class StockOrdersApi
    ...
    # @param stock_order_item [Array<StockOrderItem>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_order_items(korona_account_id, stock_order_id, stock_order_item, opts = {})
      data, _status_code, _headers = add_stock_order_items_with_http_info(korona_account_id, stock_order_id, stock_order_item, opts)
      data
    end
    ...
    def add_stock_order_items_with_http_info(korona_account_id, stock_order_id, stock_order_item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.add_stock_order_items ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.add_stock_order_items"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.add_stock_order_items"
      end
      # verify the required parameter 'stock_order_item' is set
      if @api_client.config.client_side_validation && stock_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_item' when calling StockOrdersApi.add_stock_order_items"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(stock_order_item)
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.add_stock_order_items",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#add_stock_order_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # adds stock orders
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_order [Array<StockOrder>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_orders(korona_account_id, stock_order, opts = {})
      data, _status_code, _headers = add_stock_orders_with_http_info(korona_account_id, stock_order, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_stock_orders_with_http_info(korona_account_id, stock_order, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.add_stock_orders ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.add_stock_orders"
      end
      # verify the required parameter 'stock_order' is set
      if @api_client.config.client_side_validation && stock_order.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order' when calling StockOrdersApi.add_stock_orders"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(stock_order)
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.add_stock_orders",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#add_stock_orders\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_stock_order_item(korona_account_id, stock_order_id, product_id, opts = {})
      delete_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.delete_stock_order_item ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.delete_stock_order_item"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.delete_stock_order_item"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling StockOrdersApi.delete_stock_order_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockOrders/{stockOrderId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockOrderId' + '}', CGI.escape(stock_order_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.delete_stock_order_item",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#delete_stock_order_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_stock_order_item(korona_account_id, stock_order_id, product_id, opts = {})
      data, _status_code, _headers = get_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, opts)
      data
    end
    ...
    # @param product_id [String] id of the related object (important: id should match the uuid-format)
    # @param [Hash] opts the optional parameters
    # @return [Array<(StockOrderItem, Integer, Hash)>] StockOrderItem data, response status code and response headers
    def get_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.get_stock_order_item ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.get_stock_order_item"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.get_stock_order_item"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling StockOrdersApi.get_stock_order_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockOrders/{stockOrderId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockOrderId' + '}', CGI.escape(stock_order_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StockOrderItem'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth']

      new_options = opts.merge(
        :operation => :"StockOrdersApi.get_stock_order_item",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#get_stock_order_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :external_id the external id of the object
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_order [StockOrder] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_order(korona_account_id, stock_order_id, stock_order, opts = {})
      update_stock_order_with_http_info(korona_account_id, stock_order_id, stock_order, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_order_with_http_info(korona_account_id, stock_order_id, stock_order, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.update_stock_order ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.update_stock_order"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.update_stock_order"
      end
      # verify the required parameter 'stock_order' is set
      if @api_client.config.client_side_validation && stock_order.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order' when calling StockOrdersApi.update_stock_order"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockOrders/{stockOrderId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockOrderId' + '}', CGI.escape(stock_order_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.update_stock_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#update_stock_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param stock_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param product_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_order_item [StockOrderItem] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_order_item(korona_account_id, stock_order_id, product_id, stock_order_item, opts = {})
      update_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, stock_order_item, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_order_item_with_http_info(korona_account_id, stock_order_id, product_id, stock_order_item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.update_stock_order_item ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.update_stock_order_item"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.update_stock_order_item"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling StockOrdersApi.update_stock_order_item"
      end
      # verify the required parameter 'stock_order_item' is set
      if @api_client.config.client_side_validation && stock_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_item' when calling StockOrdersApi.update_stock_order_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockOrders/{stockOrderId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockOrderId' + '}', CGI.escape(stock_order_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.update_stock_order_item",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#update_stock_order_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_order_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_order_item [Array<StockOrderItem>] data to update
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_stock_order_items(korona_account_id, stock_order_id, stock_order_item, opts = {})
      data, _status_code, _headers = update_stock_order_items_with_http_info(korona_account_id, stock_order_id, stock_order_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_stock_order_items_with_http_info(korona_account_id, stock_order_id, stock_order_item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockOrdersApi.update_stock_order_items ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling StockOrdersApi.update_stock_order_items"
      end
      # verify the required parameter 'stock_order_id' is set
      if @api_client.config.client_side_validation && stock_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_id' when calling StockOrdersApi.update_stock_order_items"
      end
      # verify the required parameter 'stock_order_item' is set
      if @api_client.config.client_side_validation && stock_order_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_order_item' when calling StockOrdersApi.update_stock_order_items"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockOrders/{stockOrderId}/items'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockOrderId' + '}', CGI.escape(stock_order_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"StockOrdersApi.update_stock_order_items",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockOrdersApi#update_stock_order_items\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
