...
module KoronaCloudClient
  class PaymentMethodsApi
    ...
    # @param payment_method [Array<PaymentMethod>] array of new payment methods
    ...
    def add_payment_methods(korona_account_id, payment_method, opts = {})
      data, _status_code, _headers = add_payment_methods_with_http_info(korona_account_id, payment_method, opts)
      data
    end
    ...
    def add_payment_methods_with_http_info(korona_account_id, payment_method, opts = {})
      ...
      if @api_client.config.client_side_validation && payment_method.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method' when calling PaymentMethodsApi.add_payment_methods"
      end
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param payment_method [Array<PaymentMethod>] array of existing payment methods (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_payment_methods(korona_account_id, payment_method, opts = {})
      data, _status_code, _headers = delete_payment_methods_with_http_info(korona_account_id, payment_method, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_payment_methods_with_http_info(korona_account_id, payment_method, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'payment_method' is set
      if @api_client.config.client_side_validation && payment_method.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method' when calling PaymentMethodsApi.delete_payment_methods"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/paymentMethods'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param payment_method_id [String] id of the related object (important: id should match the uuid-format)
    # @param payment_method [PaymentMethod] the properties to update of the payment method
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_payment_method(korona_account_id, payment_method_id, payment_method, opts = {})
      update_payment_method_with_http_info(korona_account_id, payment_method_id, payment_method, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_payment_method_with_http_info(korona_account_id, payment_method_id, payment_method, opts = {})
      if @api_client.config.debugging
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param payment_method [Array<PaymentMethod>] an array of existing payment methods
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_payment_methods(korona_account_id, payment_method, opts = {})
      data, _status_code, _headers = update_payment_methods_with_http_info(korona_account_id, payment_method, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_payment_methods_with_http_info(korona_account_id, payment_method, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'payment_method' is set
      if @api_client.config.client_side_validation && payment_method.nil?
        fail ArgumentError, "Missing the required parameter 'payment_method' when calling PaymentMethodsApi.update_payment_methods"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/paymentMethods'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
