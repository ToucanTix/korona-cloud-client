...
module KoronaCloudClient
  class StockAdjustmentsApi
    ...
    # @param stock_adjustment_item [Array<StockAdjustmentItem>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_adjustment_items(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts = {})
      data, _status_code, _headers = add_stock_adjustment_items_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts)
      data
    end
    ...
    def add_stock_adjustment_items_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts = {})
      ...
      # verify the required parameter 'stock_adjustment_item' is set
      if @api_client.config.client_side_validation && stock_adjustment_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_adjustment_item' when calling StockAdjustmentsApi.add_stock_adjustment_items"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(stock_adjustment_item)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_adjustment [Array<StockAdjustment>] data to add
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def add_stock_adjustments(korona_account_id, stock_adjustment, opts = {})
      data, _status_code, _headers = add_stock_adjustments_with_http_info(korona_account_id, stock_adjustment, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_stock_adjustments_with_http_info(korona_account_id, stock_adjustment, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && stock_adjustment.nil?
        fail ArgumentError, "Missing the required parameter 'stock_adjustment' when calling StockAdjustmentsApi.add_stock_adjustments"
      end
      # resource path
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_adjustment_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_adjustment [StockAdjustment] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_adjustment(korona_account_id, stock_adjustment_id, stock_adjustment, opts = {})
      update_stock_adjustment_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_adjustment_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_adjustment' is set
      if @api_client.config.client_side_validation && stock_adjustment.nil?
        fail ArgumentError, "Missing the required parameter 'stock_adjustment' when calling StockAdjustmentsApi.update_stock_adjustment"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockAdjustments/{stockAdjustmentId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockAdjustmentId' + '}', CGI.escape(stock_adjustment_id.to_s))
    ...
    # @param stock_adjustment_id [String] id of the related object (important: id should match the uuid-format)
    # @param product_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_adjustment_item [StockAdjustmentItem] data to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_stock_adjustment_item(korona_account_id, stock_adjustment_id, product_id, stock_adjustment_item, opts = {})
      update_stock_adjustment_item_with_http_info(korona_account_id, stock_adjustment_id, product_id, stock_adjustment_item, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_stock_adjustment_item_with_http_info(korona_account_id, stock_adjustment_id, product_id, stock_adjustment_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_adjustment_item' is set
      if @api_client.config.client_side_validation && stock_adjustment_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_adjustment_item' when calling StockAdjustmentsApi.update_stock_adjustment_item"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockAdjustments/{stockAdjustmentId}/items/{productId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockAdjustmentId' + '}', CGI.escape(stock_adjustment_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param stock_adjustment_id [String] id of the related object (important: id should match the uuid-format)
    # @param stock_adjustment_item [Array<StockAdjustmentItem>] data to update
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_stock_adjustment_items(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts = {})
      data, _status_code, _headers = update_stock_adjustment_items_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_stock_adjustment_items_with_http_info(korona_account_id, stock_adjustment_id, stock_adjustment_item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'stock_adjustment_item' is set
      if @api_client.config.client_side_validation && stock_adjustment_item.nil?
        fail ArgumentError, "Missing the required parameter 'stock_adjustment_item' when calling StockAdjustmentsApi.update_stock_adjustment_items"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/stockAdjustments/{stockAdjustmentId}/items'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'stockAdjustmentId' + '}', CGI.escape(stock_adjustment_id.to_s))
