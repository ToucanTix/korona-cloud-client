...
module KoronaCloudClient
  class PointsOfSaleApi
    ...
    def add_point_of_sale_end_of_day_statements_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'end_of_day_statement'])
    ...
    # @return [Array<AddOrUpdateResult>]
    def add_point_of_sale_pos_balances(korona_account_id, point_of_sale_id, coupling_id, opts = {})
      data, _status_code, _headers = add_point_of_sale_pos_balances_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts)
      data
    end
    ...
    # @option opts [Array<PosBalance>] :pos_balance the pos balances to add
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_point_of_sale_pos_balances_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PointsOfSaleApi.add_point_of_sale_pos_balances ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling PointsOfSaleApi.add_point_of_sale_pos_balances"
      end
      # verify the required parameter 'point_of_sale_id' is set
      if @api_client.config.client_side_validation && point_of_sale_id.nil?
        fail ArgumentError, "Missing the required parameter 'point_of_sale_id' when calling PointsOfSaleApi.add_point_of_sale_pos_balances"
      end
      # verify the required parameter 'coupling_id' is set
      if @api_client.config.client_side_validation && coupling_id.nil?
        fail ArgumentError, "Missing the required parameter 'coupling_id' when calling PointsOfSaleApi.add_point_of_sale_pos_balances"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/posBalances'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s)).sub('{pointOfSaleId}', CGI.escape(point_of_sale_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'pos_balance'])
      ...
      new_options = opts.merge(
        :operation => :"PointsOfSaleApi.add_point_of_sale_pos_balances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PointsOfSaleApi#add_point_of_sale_pos_balances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def add_point_of_sale_receipts_with_http_info(korona_account_id, point_of_sale_id, coupling_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'receipt'])
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param pos [Array<Pos>] array of new points of sale
    # @param [Hash] opts the optional parameters
    ...
    # @return [Array<AddOrUpdateResult>]
    def add_points_of_sale(korona_account_id, pos, opts = {})
      data, _status_code, _headers = add_points_of_sale_with_http_info(korona_account_id, pos, opts)
      data
    end
    ...
    # @option opts [String] :write_mode DEFAULT &#x3D; insert; ADD_OR_UPDATE &#x3D; insert or update, overwrite all non-null fields; ADD_OR_REPLACE &#x3D; insert or update, overwrite all fields
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def add_points_of_sale_with_http_info(korona_account_id, pos, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && pos.nil?
        fail ArgumentError, "Missing the required parameter 'pos' when calling PointsOfSaleApi.add_points_of_sale"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(pos)
    ...
    # @return [DefaultUser]
    def get_default_user(korona_account_id, point_of_sale_id, opts = {})
      data, _status_code, _headers = get_default_user_with_http_info(korona_account_id, point_of_sale_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :coupling_id the coupling-id of the device. It can be set to check whether your coupling-id is correct or not (works only, if point of sale is external).
    # @return [Array<(DefaultUser, Integer, Hash)>] DefaultUser data, response status code and response headers
    def get_default_user_with_http_info(korona_account_id, point_of_sale_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PointsOfSaleApi.get_default_user ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling PointsOfSaleApi.get_default_user"
      end
      # verify the required parameter 'point_of_sale_id' is set
      if @api_client.config.client_side_validation && point_of_sale_id.nil?
        fail ArgumentError, "Missing the required parameter 'point_of_sale_id' when calling PointsOfSaleApi.get_default_user"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/defaultUser'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s)).sub('{pointOfSaleId}', CGI.escape(point_of_sale_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DefaultUser'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth']

      new_options = opts.merge(
        :operation => :"PointsOfSaleApi.get_default_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PointsOfSaleApi#get_default_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_point_of_sale_max_numbers(korona_account_id, point_of_sale_id, opts = {})
      data, _status_code, _headers = get_point_of_sale_max_numbers_with_http_info(korona_account_id, point_of_sale_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :coupling_id the coupling-id of the device. It can be set to check whether your coupling-id is correct or not (works only, if point of sale is external).
    # @return [Array<(PosMaxNumbers, Integer, Hash)>] PosMaxNumbers data, response status code and response headers
    def get_point_of_sale_max_numbers_with_http_info(korona_account_id, point_of_sale_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PointsOfSaleApi.get_point_of_sale_max_numbers ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling PointsOfSaleApi.get_point_of_sale_max_numbers"
      end
      # verify the required parameter 'point_of_sale_id' is set
      if @api_client.config.client_side_validation && point_of_sale_id.nil?
        fail ArgumentError, "Missing the required parameter 'point_of_sale_id' when calling PointsOfSaleApi.get_point_of_sale_max_numbers"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}/maxNumbers'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s)).sub('{pointOfSaleId}', CGI.escape(point_of_sale_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PosMaxNumbers'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth']

      new_options = opts.merge(
        :operation => :"PointsOfSaleApi.get_point_of_sale_max_numbers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PointsOfSaleApi#get_point_of_sale_max_numbers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param point_of_sale_id [String] id of the related object (important: id should match the uuid-format)
    # @param pos [Pos] the properties to update of the point of sale (&#39;couplingId&#39; only)
    # @param [Hash] opts the optional parameters
    ...
    # @return [nil]
    def update_point_of_sale(korona_account_id, point_of_sale_id, pos, opts = {})
      update_point_of_sale_with_http_info(korona_account_id, point_of_sale_id, pos, opts)
      nil
    end
    ...
    def update_point_of_sale_with_http_info(korona_account_id, point_of_sale_id, pos, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pos' is set
      if @api_client.config.client_side_validation && pos.nil?
        fail ArgumentError, "Missing the required parameter 'pos' when calling PointsOfSaleApi.update_point_of_sale"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/pointsOfSale/{pointOfSaleId}'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s)).sub('{pointOfSaleId}', CGI.escape(point_of_sale_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param pos [Array<Pos>] an array of existing points of sale
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_points_of_sale(korona_account_id, pos, opts = {})
      data, _status_code, _headers = update_points_of_sale_with_http_info(korona_account_id, pos, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_points_of_sale_with_http_info(korona_account_id, pos, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pos' is set
      if @api_client.config.client_side_validation && pos.nil?
        fail ArgumentError, "Missing the required parameter 'pos' when calling PointsOfSaleApi.update_points_of_sale"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/pointsOfSale'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
