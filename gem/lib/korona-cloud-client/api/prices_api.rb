...
module KoronaCloudClient
  class PricesApi
    ...
    # @option opts [Time] :min_valid_from min (inclusive) timestamp for validFrom (ISO 8601; Format: YYYY-MM-DDTHH:MM:SS; timezone optional)
    # @option opts [String] :price_group price group
    ...
    def get_prices_with_http_info(korona_account_id, opts = {})
      ...
      query_params[:'minValidFrom'] = opts[:'min_valid_from'] if !opts[:'min_valid_from'].nil?
      query_params[:'priceGroup'] = opts[:'price_group'] if !opts[:'price_group'].nil?
