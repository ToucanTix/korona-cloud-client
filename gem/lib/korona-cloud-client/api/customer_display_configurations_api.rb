...
module KoronaCloudClient
  class CustomerDisplayConfigurationsApi
    ...
    # @param customer_display_configuration [Array<CustomerDisplayConfiguration>] array of new customer display configurations
    ...
    def add_customer_display_configurations(korona_account_id, customer_display_configuration, opts = {})
      data, _status_code, _headers = add_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts)
      data
    end
    ...
    def add_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts = {})
      ...
      # verify the required parameter 'customer_display_configuration' is set
      if @api_client.config.client_side_validation && customer_display_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'customer_display_configuration' when calling CustomerDisplayConfigurationsApi.add_customer_display_configurations"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(customer_display_configuration)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param customer_display_configuration [Array<CustomerDisplayConfiguration>] an array of existing customer display configurations
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_customer_display_configurations(korona_account_id, customer_display_configuration, opts = {})
      data, _status_code, _headers = delete_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'customer_display_configuration' is set
      if @api_client.config.client_side_validation && customer_display_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'customer_display_configuration' when calling CustomerDisplayConfigurationsApi.delete_customer_display_configurations"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/customerDisplayConfigurations'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_customer_display_configurations(korona_account_id, customer_display_configuration, opts = {})
      data, _status_code, _headers = update_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_customer_display_configurations_with_http_info(korona_account_id, customer_display_configuration, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'customer_display_configuration' is set
      if @api_client.config.client_side_validation && customer_display_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'customer_display_configuration' when calling CustomerDisplayConfigurationsApi.update_customer_display_configurations"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/customerDisplayConfigurations'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
