...
module KoronaCloudClient
  class AdditionalReceiptInfoTypesApi
    ...
    # @param additional_receipt_info_type [Array<AdditionalReceiptInfoType>] array of new additional receipt infos
    ...
    def add_additional_receipt_info_types(korona_account_id, additional_receipt_info_type, opts = {})
      data, _status_code, _headers = add_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts)
      data
    end
    ...
    def add_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts = {})
      ...
      # verify the required parameter 'additional_receipt_info_type' is set
      if @api_client.config.client_side_validation && additional_receipt_info_type.nil?
        fail ArgumentError, "Missing the required parameter 'additional_receipt_info_type' when calling AdditionalReceiptInfoTypesApi.add_additional_receipt_info_types"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(additional_receipt_info_type)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param additional_receipt_info_type [Array<AdditionalReceiptInfoType>] array of existing additional receipt infos (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_additional_receipt_info_types(korona_account_id, additional_receipt_info_type, opts = {})
      data, _status_code, _headers = delete_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'additional_receipt_info_type' is set
      if @api_client.config.client_side_validation && additional_receipt_info_type.nil?
        fail ArgumentError, "Missing the required parameter 'additional_receipt_info_type' when calling AdditionalReceiptInfoTypesApi.delete_additional_receipt_info_types"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/additionalReceiptInfoTypes'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param additional_receipt_info_type_id [String] id of the related object (important: id should match the uuid-format)
    # @param additional_receipt_info_type [AdditionalReceiptInfoType] the object to update
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_additional_receipt_info_type(korona_account_id, additional_receipt_info_type_id, additional_receipt_info_type, opts = {})
      update_additional_receipt_info_type_with_http_info(korona_account_id, additional_receipt_info_type_id, additional_receipt_info_type, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_additional_receipt_info_type_with_http_info(korona_account_id, additional_receipt_info_type_id, additional_receipt_info_type, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'additional_receipt_info_type' is set
      if @api_client.config.client_side_validation && additional_receipt_info_type.nil?
        fail ArgumentError, "Missing the required parameter 'additional_receipt_info_type' when calling AdditionalReceiptInfoTypesApi.update_additional_receipt_info_type"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/additionalReceiptInfoTypes/{additionalReceiptInfoTypeId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'additionalReceiptInfoTypeId' + '}', CGI.escape(additional_receipt_info_type_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param additional_receipt_info_type [Array<AdditionalReceiptInfoType>] an array of existing additional receipt infos
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_additional_receipt_info_types(korona_account_id, additional_receipt_info_type, opts = {})
      data, _status_code, _headers = update_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_additional_receipt_info_types_with_http_info(korona_account_id, additional_receipt_info_type, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'additional_receipt_info_type' is set
      if @api_client.config.client_side_validation && additional_receipt_info_type.nil?
        fail ArgumentError, "Missing the required parameter 'additional_receipt_info_type' when calling AdditionalReceiptInfoTypesApi.update_additional_receipt_info_types"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/additionalReceiptInfoTypes'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
