...
module KoronaCloudClient
  class ProductsApi
    ...
    def add_products_with_http_info(korona_account_id, product, opts = {})
      ...
      query_params[:'mergeTags'] = opts[:'merge_tags'] if !opts[:'merge_tags'].nil?
    ...
    # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
    # @return [ResultListProductStock]
    def get_product_stocks1(korona_account_id, product_id, opts = {})
      data, _status_code, _headers = get_product_stocks1_with_http_info(korona_account_id, product_id, opts)
      data
    end
    ...
    # @option opts [Integer] :revision last revision number, objects with a greater revision than this will be returned
    # @return [Array<(ResultListProductStock, Integer, Hash)>] ResultListProductStock data, response status code and response headers
    def get_product_stocks1_with_http_info(korona_account_id, product_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductsApi.get_product_stocks1 ...'
      end
      # verify the required parameter 'korona_account_id' is set
      if @api_client.config.client_side_validation && korona_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'korona_account_id' when calling ProductsApi.get_product_stocks1"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling ProductsApi.get_product_stocks1"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/products/{productId}/stocks'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'productId' + '}', CGI.escape(product_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ProductsApi.get_product_stocks1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#get_product_stocks1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_products_with_http_info(korona_account_id, opts = {})
      ...
      query_params[:'omitPageCounts'] = opts[:'omit_page_counts'] if !opts[:'omit_page_counts'].nil?
