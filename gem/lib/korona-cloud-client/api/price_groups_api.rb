...
module KoronaCloudClient
  class PriceGroupsApi
    ...
    # @param price_group [Array<PriceGroup>] array of new price groups
    ...
    def add_price_groups(korona_account_id, price_group, opts = {})
      data, _status_code, _headers = add_price_groups_with_http_info(korona_account_id, price_group, opts)
      data
    end
    ...
    def add_price_groups_with_http_info(korona_account_id, price_group, opts = {})
      ...
      # verify the required parameter 'price_group' is set
      if @api_client.config.client_side_validation && price_group.nil?
        fail ArgumentError, "Missing the required parameter 'price_group' when calling PriceGroupsApi.add_price_groups"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(price_group)
    ...
    # @param korona_account_id [String] account id of the KORONA Studio account
    # @param price_group [Array<PriceGroup>] array of existing price groups (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_price_groups(korona_account_id, price_group, opts = {})
      data, _status_code, _headers = delete_price_groups_with_http_info(korona_account_id, price_group, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_price_groups_with_http_info(korona_account_id, price_group, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'price_group' is set
      if @api_client.config.client_side_validation && price_group.nil?
        fail ArgumentError, "Missing the required parameter 'price_group' when calling PriceGroupsApi.delete_price_groups"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/priceGroups'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_price_groups(korona_account_id, price_group, opts = {})
      data, _status_code, _headers = update_price_groups_with_http_info(korona_account_id, price_group, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_price_groups_with_http_info(korona_account_id, price_group, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'price_group' is set
      if @api_client.config.client_side_validation && price_group.nil?
        fail ArgumentError, "Missing the required parameter 'price_group' when calling PriceGroupsApi.update_price_groups"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/priceGroups'.sub('{koronaAccountId}', CGI.escape(korona_account_id.to_s))
