...
module KoronaCloudClient
  class ReceiptItem < ApiModelBase
    ...
    attr_accessor :return_original_receipt_reference
    ...
    # Container quantity.
    attr_accessor :container_quantity
    ...
    def self.attribute_map
      {
        ...
        :'return_original_receipt_reference' => :'returnOriginalReceiptReference',
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'voucher_transaction' => :'VoucherTransactionOld',
        :'voucher_transaction_reference' => :'ModelReference',
        :'special_price_configuration' => :'ModelReference',
        :'return_original_receipt_reference' => :'ModelReference',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::ReceiptItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'return_original_receipt_reference')
      ...
      if attributes.key?(:'container_quantity')
        self.container_quantity = attributes[:'container_quantity']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          return_original_receipt_reference == o.return_original_receipt_reference &&
    ...
    def hash
      [attendance, booking_time, commodity_group, description, discounts, id, indent, index, info_texts, manual_price, product, quantity, sector, serial_numbers, total, delivery_date, external_references, recognition_number, type, voucher_transaction, voucher_transaction_reference, special_price_configuration, return_original_receipt_reference, return_reason, seller, container_quantity, costs].hash
    end
