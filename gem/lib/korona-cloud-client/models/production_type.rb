...
module KoronaCloudClient
  class ProductionType < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::ProductionType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["PRINT", "PRINT_MERGED", "TICKET_ACTIVATE", "TICKET_PRINT", "TICKET_ACTIVATE_PRINT", "TICKET_VALIDATE_PRINT", "KORONA_PREPAID", "KORONA_PREPAID_PRINT", "EXTERNAL_SYSTEM_CALL", "VOUCHER_PRINT", "EXTERNAL_SYSTEM_CALL_WITH_FEEDBACK", "TICKET_VALIDATE"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["PRINT", "PRINT_MERGED", "TICKET_ACTIVATE", "TICKET_PRINT", "TICKET_ACTIVATE_PRINT", "TICKET_VALIDATE_PRINT", "KORONA_PREPAID", "KORONA_PREPAID_PRINT", "EXTERNAL_SYSTEM_CALL", "VOUCHER_PRINT", "EXTERNAL_SYSTEM_CALL_WITH_FEEDBACK", "TICKET_VALIDATE"])
    ...
    def hash
      [active, id, revision, number, name, method, trigger, sub_producer, external_system_call].hash
    end
