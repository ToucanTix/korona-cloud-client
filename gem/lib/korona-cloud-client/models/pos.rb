...
module KoronaCloudClient
  # Point-of-sale workstation configuration, including device coupling, fiscalization, and default master-data assignments.
  class Pos < ApiModelBase
    ...
    # How container selection is handled at this POS (disabled, always on, or user-controlled).
    attr_accessor :container_selection

    attr_accessor :contra_account

    # Read-only flag indicating whether this POS is currently coupled to an external client system.
    attr_accessor :coupled

    # Coupled client system information.
    ...
    # Fiscalization provider/implementation used by this POS.
    ...
    # Info-text entries printed/shown with receipts on this POS.
    ...
    # If enabled, alternative sector logic is used for selected transaction flows.
    attr_accessor :use_alternative_sector

    attr_accessor :warehouse

    # Device configuration variable values.
    attr_accessor :device_configuration_variable_values

    # Provider type of the linked payment service integration.
    attr_accessor :type

    attr_accessor :sco_configuration

    attr_accessor :surcharge_account
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::Pos`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'surcharge_account')
        self.surcharge_account = attributes[:'surcharge_account']
      end
    end
    ...
    # @param [Object] container_selection Object to be assigned
    def container_selection=(container_selection)
      validator = EnumAttributeValidator.new('String', ["OFF", "ON", "BY_USER"])
      unless validator.valid?(container_selection)
        fail ArgumentError, "invalid value for \"container_selection\", must be one of #{validator.allowable_values}."
      end
    ...
    def device_configuration_variable_values=(device_configuration_variable_values)
      if device_configuration_variable_values.nil?
        fail ArgumentError, 'device_configuration_variable_values cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          surcharge_account == o.surcharge_account
    end
