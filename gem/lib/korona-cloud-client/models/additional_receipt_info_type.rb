...
module KoronaCloudClient
  class AdditionalReceiptInfoType < ApiModelBase
    ...
    # If true, cashier input required.
    ...
    # Reference to the points of sale associated with this resource.
    attr_accessor :points_of_sale

    # Points of sale selection mode.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::AdditionalReceiptInfoType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
