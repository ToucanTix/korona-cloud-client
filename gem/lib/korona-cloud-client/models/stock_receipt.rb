...
module KoronaCloudClient
  class StockReceipt < ApiModelBase
    ...
    # Custom price change.
    attr_accessor :custom_price_change

    # If true, ignore purchase price.
    attr_accessor :ignore_purchase_price
    ...
    def self.attribute_map
      {
        ...
        :'ignore_purchase_price' => :'ignorePurchasePrice',
        :'status' => :'status'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KoronaCloudClient::StockReceipt` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::StockReceipt`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'custom_price_change')
        self.custom_price_change = attributes[:'custom_price_change']
      end

      if attributes.key?(:'ignore_purchase_price')
        self.ignore_purchase_price = attributes[:'ignore_purchase_price']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_purchase_price == o.ignore_purchase_price &&
          status == o.status
    end
    ...
    def hash
      [active, id, revision, number, arrival_date, booking_time, booking_user, booking_api_user, cashier, create_time, create_user, customer, description, dispatch_notification, items_count, organizational_unit, party_information, point_of_sale, product_stock_order, source_organizational_unit, supplier, comment, custom_price_change, ignore_purchase_price, status].hash
    end
