...
module KoronaCloudClient
  class TicketDefinition < ApiModelBase
    ...
    # If true, count statistically.
    attr_accessor :count_statistically

    # Reference to the entry gates associated with this resource.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::TicketDefinition`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def entry_gates=(entry_gates)
      if entry_gates.nil?
        fail ArgumentError, 'entry_gates cannot be nil'
      end
