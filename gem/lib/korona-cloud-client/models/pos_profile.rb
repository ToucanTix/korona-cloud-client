...
module KoronaCloudClient
  # Point-of-sale profile that controls cashier workflow, receipt behavior, and runtime integrations.
  class PosProfile < ApiModelBase
    ...
    # If enabled, receipts are printed automatically after successful payment.
    attr_accessor :auto_receipt_print

    # If enabled, a closed cash drawer state is enforced before continuing certain payment operations. Please be aware that not all POS terminals support this feature.
    attr_accessor :force_closed_drawer

    # If enabled, the cashier must explicitly select a cash drawer before payment actions.
    attr_accessor :force_drawer_selection

    # If enabled, entering a guest count is required before completing a transaction.
    attr_accessor :guest_count_required

    # If enabled, the receipt-print button stays visible while a drawer is open.
    attr_accessor :show_receipt_print_button_on_opened_drawer

    # Maximum number of balance attempts allowed before requiring intervention.
    attr_accessor :max_balance_attempts

    # If enabled, an order number is required for applicable sales workflows.
    attr_accessor :order_number_required

    # Payment service integrations available for this POS profile.
    attr_accessor :payment_service_configurations

    # Device-specific configuration blocks applied to this POS profile.
    ...
    # If enabled, numeric keypad input is interpreted in cent-based mode.
    attr_accessor :cent_input

    # If enabled, the cashier must explicitly enter the paid amount during checkout.
    attr_accessor :require_payment_amount_input

    # If enabled, the POS runs in kiosk-oriented interaction mode.
    attr_accessor :kiosk_mode

    # If enabled, POS screens use the wide-screen optimized layout.
    attr_accessor :wide_screen_layout

    # If enabled, payments are finalized automatically when business rules allow it.
    attr_accessor :automatic_payment_finalization

    # If enabled, quick-access pad selections are reset automatically after use.
    attr_accessor :auto_reset_quick_access_pad

    # If enabled, recently sold products can be repeated quickly in the current receipt.
    attr_accessor :easy_repeat_product_enabled

    # External system calls triggered when a receipt is booked.
    attr_accessor :external_system_calls_on_book_receipt

    # External system calls triggered when a receipt booking is rejected.
    attr_accessor :external_system_calls_on_reject_receipt

    # External system calls triggered when the receipt reaches total/payment stage.
    attr_accessor :external_system_calls_on_total_receipt

    # External system calls triggered when a receipt is voided.
    attr_accessor :external_system_calls_on_void_receipt

    # External system calls triggered when a delivery note is booked.
    attr_accessor :external_system_calls_on_book_delivery_note

    # External system calls triggered when a receipt is reversed.
    attr_accessor :external_system_calls_on_reverse_receipt

    # External system calls triggered when a cashier logs in.
    attr_accessor :external_system_calls_on_login_cashier

    # External system calls triggered when a cashier logs out.
    attr_accessor :external_system_calls_on_logout_cashier

    # External system calls triggered when the first sale is booked after opening.
    attr_accessor :external_system_calls_on_book_first_sale

    # External system calls triggered when opening a non-empty parked receipt.
    attr_accessor :external_system_calls_on_open_non_empty_receipt

    # External system calls triggered during return transactions.
    attr_accessor :external_system_calls_on_return

    # If enabled, balance differences are designated/posted automatically by POS logic.
    attr_accessor :designate_balance_difference

    # If enabled, POS can generate the end-of-day report flow for this profile.
    attr_accessor :end_of_day_report_enabled

    # Behavior triggered when an unknown number is entered at POS.
    attr_accessor :unknown_number_action

    attr_accessor :unknown_number_external_system_call

    # Number of receipt copies printed for invoicing workflows.
    attr_accessor :invoicing_receipt_copies

    # If enabled, cashier password verification is required for login.
    attr_accessor :cashier_password_required

    # Visual theme used by the POS user interface.
    attr_accessor :pos_theme

    attr_accessor :template_product

    # If enabled, digital receipt delivery options are available at checkout.
    attr_accessor :digital_receipt

    # If enabled, digital signature capture is available for supported transactions.
    attr_accessor :digital_signature

    # If enabled, a customer can be created automatically from customer-order data when needed.
    attr_accessor :automatic_customer_creation_from_customer_order

    attr_accessor :master_data_refresh_interval

    # If enabled, selecting a return reason is mandatory for return transactions.
    attr_accessor :mandatory_return_reason

    # If enabled, each POS is limited to one parked receipt at a time.
    attr_accessor :restrict_to_one_parked_receipt

    # If enabled, automatic logout also locks the cashier account for re-authentication.
    attr_accessor :automatic_cashier_logout_lock_cashier

    attr_accessor :report_file

    # If enabled, banknote suggestions are shown only in payment-denomination context.
    attr_accessor :show_bank_notes_for_payment_denomination_only

    # If enabled, an end-of-day statement is prompted/executed after closing workflows.
    attr_accessor :end_of_day_statement_afterwards

    # If enabled, parked receipts are cancelled when the end-of-day statement is run.
    attr_accessor :cancel_parked_receipts_on_end_of_day_statement

    # If enabled, a reversal reason is required when reversing receipts.
    attr_accessor :force_receipt_reversal_reason

    # if enabled, a starting balance is required when a cashier logs in.
    attr_accessor :force_starting_balance

    # If enabled, product availability is filtered by assortments assigned to the organizational unit.
    attr_accessor :filter_products_by_organization_assortments

    attr_accessor :stock_return_required_cashier_role

    # Threshold amount from which stock returns require multi-cashier authorization.
    attr_accessor :stock_return_multi_cashier_authorization_from

    # Maximum cash amount allowed before warning or restriction logic applies.
    attr_accessor :max_cash_amount

    # If enabled, cashiers are warned about open receipts before logout.
    attr_accessor :show_open_receipt_warning_on_logout
    ...
    def self.attribute_map
      {
        ...
        :'force_drawer_selection' => :'forceDrawerSelection',
        :'guest_count_required' => :'guestCountRequired',
        :'show_receipt_print_button_on_opened_drawer' => :'showReceiptPrintButtonOnOpenedDrawer',
        ...
        :'external_system_calls_on_book_first_sale' => :'externalSystemCallsOnBookFirstSale',
        :'external_system_calls_on_open_non_empty_receipt' => :'externalSystemCallsOnOpenNonEmptyReceipt',
        :'external_system_calls_on_return' => :'externalSystemCallsOnReturn',
        ...
        :'end_of_day_statement_afterwards' => :'endOfDayStatementAfterwards',
        :'cancel_parked_receipts_on_end_of_day_statement' => :'cancelParkedReceiptsOnEndOfDayStatement',
        :'force_receipt_reversal_reason' => :'forceReceiptReversalReason',
        :'force_starting_balance' => :'forceStartingBalance',
        :'filter_products_by_organization_assortments' => :'filterProductsByOrganizationAssortments',
        :'stock_return_required_cashier_role' => :'stockReturnRequiredCashierRole',
        :'stock_return_multi_cashier_authorization_from' => :'stockReturnMultiCashierAuthorizationFrom',
        :'max_cash_amount' => :'maxCashAmount',
        :'show_open_receipt_warning_on_logout' => :'showOpenReceiptWarningOnLogout'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'force_drawer_selection' => :'Boolean',
        :'guest_count_required' => :'Boolean',
        :'show_receipt_print_button_on_opened_drawer' => :'Boolean',
        ...
        :'external_system_calls_on_book_first_sale' => :'Array<ModelReference>',
        :'external_system_calls_on_open_non_empty_receipt' => :'Array<ModelReference>',
        :'external_system_calls_on_return' => :'Array<ModelReference>',
        ...
        :'end_of_day_statement_afterwards' => :'Boolean',
        :'cancel_parked_receipts_on_end_of_day_statement' => :'Boolean',
        :'force_receipt_reversal_reason' => :'Boolean',
        :'force_starting_balance' => :'Boolean',
        :'filter_products_by_organization_assortments' => :'Boolean',
        :'stock_return_required_cashier_role' => :'ModelReference',
        :'stock_return_multi_cashier_authorization_from' => :'Float',
        :'max_cash_amount' => :'Float',
        :'show_open_receipt_warning_on_logout' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::PosProfile`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'force_drawer_selection')
        self.force_drawer_selection = attributes[:'force_drawer_selection']
      end

      if attributes.key?(:'guest_count_required')
        self.guest_count_required = attributes[:'guest_count_required']
      end

      if attributes.key?(:'show_receipt_print_button_on_opened_drawer')
        self.show_receipt_print_button_on_opened_drawer = attributes[:'show_receipt_print_button_on_opened_drawer']
      end
      ...
      if attributes.key?(:'external_system_calls_on_book_first_sale')
        if (value = attributes[:'external_system_calls_on_book_first_sale']).is_a?(Array)
          self.external_system_calls_on_book_first_sale = value
        end
      end

      if attributes.key?(:'external_system_calls_on_open_non_empty_receipt')
        if (value = attributes[:'external_system_calls_on_open_non_empty_receipt']).is_a?(Array)
          self.external_system_calls_on_open_non_empty_receipt = value
        end
      end

      if attributes.key?(:'external_system_calls_on_return')
        if (value = attributes[:'external_system_calls_on_return']).is_a?(Array)
          self.external_system_calls_on_return = value
        end
      end
      ...
      if attributes.key?(:'end_of_day_statement_afterwards')
        self.end_of_day_statement_afterwards = attributes[:'end_of_day_statement_afterwards']
      end

      if attributes.key?(:'cancel_parked_receipts_on_end_of_day_statement')
        self.cancel_parked_receipts_on_end_of_day_statement = attributes[:'cancel_parked_receipts_on_end_of_day_statement']
      end

      if attributes.key?(:'force_receipt_reversal_reason')
        self.force_receipt_reversal_reason = attributes[:'force_receipt_reversal_reason']
      end

      if attributes.key?(:'force_starting_balance')
        self.force_starting_balance = attributes[:'force_starting_balance']
      end

      if attributes.key?(:'filter_products_by_organization_assortments')
        self.filter_products_by_organization_assortments = attributes[:'filter_products_by_organization_assortments']
      end

      if attributes.key?(:'stock_return_required_cashier_role')
        self.stock_return_required_cashier_role = attributes[:'stock_return_required_cashier_role']
      end

      if attributes.key?(:'stock_return_multi_cashier_authorization_from')
        self.stock_return_multi_cashier_authorization_from = attributes[:'stock_return_multi_cashier_authorization_from']
      end

      if attributes.key?(:'max_cash_amount')
        self.max_cash_amount = attributes[:'max_cash_amount']
      end

      if attributes.key?(:'show_open_receipt_warning_on_logout')
        self.show_open_receipt_warning_on_logout = attributes[:'show_open_receipt_warning_on_logout']
      end
    end
    ...
    def payment_service_configurations=(payment_service_configurations)
      if payment_service_configurations.nil?
        fail ArgumentError, 'payment_service_configurations cannot be nil'
      end
    ...
    def device_profile_configurations=(device_profile_configurations)
      if device_profile_configurations.nil?
        fail ArgumentError, 'device_profile_configurations cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          force_drawer_selection == o.force_drawer_selection &&
          guest_count_required == o.guest_count_required &&
          show_receipt_print_button_on_opened_drawer == o.show_receipt_print_button_on_opened_drawer &&
          ...
          external_system_calls_on_book_first_sale == o.external_system_calls_on_book_first_sale &&
          external_system_calls_on_open_non_empty_receipt == o.external_system_calls_on_open_non_empty_receipt &&
          external_system_calls_on_return == o.external_system_calls_on_return &&
          ...
          end_of_day_statement_afterwards == o.end_of_day_statement_afterwards &&
          cancel_parked_receipts_on_end_of_day_statement == o.cancel_parked_receipts_on_end_of_day_statement &&
          force_receipt_reversal_reason == o.force_receipt_reversal_reason &&
          force_starting_balance == o.force_starting_balance &&
          filter_products_by_organization_assortments == o.filter_products_by_organization_assortments &&
          stock_return_required_cashier_role == o.stock_return_required_cashier_role &&
          stock_return_multi_cashier_authorization_from == o.stock_return_multi_cashier_authorization_from &&
          max_cash_amount == o.max_cash_amount &&
          show_open_receipt_warning_on_logout == o.show_open_receipt_warning_on_logout
    end
    ...
    def hash
      [active, id, revision, number, name, automatic_cashier_logout_interval, auto_receipt_print, force_closed_drawer, force_drawer_selection, guest_count_required, show_receipt_print_button_on_opened_drawer, max_balance_attempts, order_number_required, payment_service_configurations, device_profile_configurations, table_service_interval, receipt_layout_configuration, automatic_end_of_day_interval, cent_input, require_payment_amount_input, kiosk_mode, wide_screen_layout, automatic_payment_finalization, auto_reset_quick_access_pad, easy_repeat_product_enabled, external_system_calls_on_book_receipt, external_system_calls_on_reject_receipt, external_system_calls_on_total_receipt, external_system_calls_on_void_receipt, external_system_calls_on_book_delivery_note, external_system_calls_on_reverse_receipt, external_system_calls_on_login_cashier, external_system_calls_on_logout_cashier, external_system_calls_on_book_first_sale, external_system_calls_on_open_non_empty_receipt, external_system_calls_on_return, designate_balance_difference, end_of_day_report_enabled, unknown_number_action, unknown_number_external_system_call, invoicing_receipt_copies, cashier_password_required, pos_theme, template_product, digital_receipt, digital_signature, automatic_customer_creation_from_customer_order, master_data_refresh_interval, mandatory_return_reason, restrict_to_one_parked_receipt, automatic_cashier_logout_lock_cashier, report_file, show_bank_notes_for_payment_denomination_only, end_of_day_statement_afterwards, cancel_parked_receipts_on_end_of_day_statement, force_receipt_reversal_reason, force_starting_balance, filter_products_by_organization_assortments, stock_return_required_cashier_role, stock_return_multi_cashier_authorization_from, max_cash_amount, show_open_receipt_warning_on_logout].hash
    end
