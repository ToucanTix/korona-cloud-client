...
module KoronaCloudClient
  # A stock order used to order items from suppliers or other organizational units.
  class StockOrder < ApiModelBase
    ...
    # Timestamp when the stock order was booked. yyyy-MM-dd'T'HH:mm:ssXXX
    ...
    # Optional comment for the stock order. This is an internal note is not visible to the supplier
    attr_accessor :comment

    # Timestamp when the stock order was created. yyyy-MM-dd'T'HH:mm:ssXXX
    ...
    # Deposit amount associated with this stock order.
    attr_accessor :deposit

    # Description of the stock order. This is visible to the supplier.
    attr_accessor :description

    # Expected start date/time for delivery or availability. yyyy-MM-dd'T'HH:mm:ssXXX
    attr_accessor :expected_from_date

    # Expected end date/time for delivery or availability. yyyy-MM-dd'T'HH:mm:ssXXX
    attr_accessor :expected_to_date

    # If true, this stock order has been finalized.
    attr_accessor :finalized

    # List of items included in this stock order.
    attr_accessor :items

    # Number of items in this stock order.
    ...
    # Planned pickup date/time for this stock order. yyyy-MM-dd'T'HH:mm:ssXXX
    attr_accessor :pickup_date

    attr_accessor :point_of_sale

    # Shipping condition for this stock order.
    attr_accessor :shipping_condition

    # Supplier shipping information for this stock order.
    attr_accessor :shipping_supplier_information

    attr_accessor :source_organizational_unit

    # Special offer code applied to this stock order.
    attr_accessor :special_offer_code

    attr_accessor :store_order

    # External identifier for the stock order.
    attr_accessor :external_id

    attr_accessor :supplier

    # Current booking status of the stock order.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KoronaCloudClient::StockOrder`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
